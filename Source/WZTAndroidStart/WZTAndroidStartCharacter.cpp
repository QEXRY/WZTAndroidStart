...
AWZTAndroidStartCharacter::AWZTAndroidStartCharacter()
{
...
void AWZTAndroidStartCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AWZTAndroidStartCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
